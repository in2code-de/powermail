...
/**
 * Class RestrictedViewHelperInvoker
 *
 * Second net below RestrictedViewHelperResolver.
 *
 * This is NOT a sandbox: every ViewHelper that overrides compile()/convert() emits inline PHP and
 * never reaches invoke() - among them f:format.raw, f:then, f:else, f:switch, f:section and f:layout.
 * The resolver is what actually blocks those, because it prevents the node from being created at all.
 *
 ...
 */
class RestrictedViewHelperInvoker extends ViewHelperInvoker
{
    /**
     * @var array
     */
