...
+function (t) {
  ...
  function e(e) {
    return this.each(function () {
      ...
      n || o.data("bs.button", n = new _i(this, s)), "toggle" == e ? n.toggle() : e && n.setState(e);
    });
  }
  var _i = function i(e, o) {
    this.$element = t(e), this.options = t.extend({}, _i.DEFAULTS, o), this.isLoading = !1;
  };
  _i.VERSION = "3.3.7", _i.DEFAULTS = {
    loadingText: "loading..."
  }, _i.prototype.setState = function (e) {
    var i = "disabled",
      o = this.$element,
  ...
  var o = t.fn.button;
  t.fn.button = e, t.fn.button.Constructor = _i, t.fn.button.noConflict = function () {
  ...
  function i(e) {
    return this.each(function () {
      var i = t(this),
        ...
        s = t.extend({}, _o.DEFAULTS, i.data(), "object" == _typeof(e) && e);
      !n && s.toggle && /show|hide/.test(e) && (s.toggle = !1), n || i.data("bs.collapse", n = new _o(this, s)), "string" == typeof e && n[e]();
    });
  }
  var _o = function o(e, i) {
    this.$element = t(e), this.options = t.extend({}, _o.DEFAULTS, i), this.$trigger = t('[data-toggle="collapse"][href="#' + e.id + '"],[data-toggle="collapse"][data-target="#' + e.id + '"]'), this.transitioning = null, this.options.parent ? this.$parent = this.getParent() : this.addAriaAndCollapsedClass(this.$element, this.$trigger), this.options.toggle && this.toggle();
  };
  _o.VERSION = "3.3.7", _o.TRANSITION_DURATION = 350, _o.DEFAULTS = {
    toggle: !0
  }, _o.prototype.dimension = function () {
    ...
    if (!this.transitioning && !this.$element.hasClass("in")) {
      ...
      if (!(n && n.length && (e = n.data("bs.collapse"), e && e.transitioning))) {
        ...
        if (this.$element.trigger(s), !s.isDefaultPrevented()) {
          ...
          this.$element.one("bsTransitionEnd", t.proxy(r, this)).emulateTransitionEnd(_o.TRANSITION_DURATION)[a](this.$element[0][l]);
        }
      }
    }
    ...
    if (!this.transitioning && this.$element.hasClass("in")) {
      ...
      if (this.$element.trigger(e), !e.isDefaultPrevented()) {
        ...
        return t.support.transition ? void this.$element[i](0).one("bsTransitionEnd", t.proxy(n, this)).emulateTransitionEnd(_o.TRANSITION_DURATION) : n.call(this);
      }
    }
  }, _o.prototype.toggle = function () {
    this[this.$element.hasClass("in") ? "hide" : "show"]();
  }, _o.prototype.getParent = function () {
    return t(this.options.parent).find('[data-toggle="collapse"][data-parent="' + this.options.parent + '"]').each(t.proxy(function (i, o) {
      var n = t(o);
      this.addAriaAndCollapsedClass(e(n), n);
    }, this)).end();
  }, _o.prototype.addAriaAndCollapsedClass = function (t, e) {
    var i = t.hasClass("in");
    t.attr("aria-expanded", i), e.toggleClass("collapsed", !i).attr("aria-expanded", i);
  };
  var n = t.fn.collapse;
  t.fn.collapse = i, t.fn.collapse.Constructor = _o, t.fn.collapse.noConflict = function () {
  ...
  i.VERSION = "3.3.7", i.TRANSITION_DURATION = 150, i.DEFAULTS = {
    ...
    var e = this.$element,
      i = this.options;
    return e.attr("data-original-title") || ("function" == typeof i.title ? i.title.call(e[0]) : i.title);
  ...
  function e(e) {
    return this.each(function () {
      var o = t(this),
        n = o.data("bs.affix"),
        s = "object" == _typeof(e) && e;
      n || o.data("bs.affix", n = new _i4(this, s)), "string" == typeof e && n[e]();
    });
  }
  var _i4 = function i(e, o) {
    this.options = t.extend({}, _i4.DEFAULTS, o), this.$target = t(this.options.target).on("scroll.bs.affix.data-api", t.proxy(this.checkPosition, this)).on("click.bs.affix.data-api", t.proxy(this.checkPositionWithEventLoop, this)), this.$element = t(e), this.affixed = null, this.unpin = null, this.pinnedOffset = null, this.checkPosition();
  };
  _i4.VERSION = "3.3.7", _i4.RESET = "affix affix-top affix-bottom", _i4.DEFAULTS = {
    offset: 0,
    target: window
  }, _i4.prototype.getState = function (t, e, i, o) {
  ...
  }, _i4.prototype.getPinnedOffset = function () {
    if (this.pinnedOffset) return this.pinnedOffset;
    this.$element.removeClass(_i4.RESET).addClass("affix");
    var t = this.$target.scrollTop(),
      e = this.$element.offset();
    return this.pinnedOffset = e.top - t;
  }, _i4.prototype.checkPositionWithEventLoop = function () {
    setTimeout(t.proxy(this.checkPosition, this), 1);
  }, _i4.prototype.checkPosition = function () {
    if (this.$element.is(":visible")) {
      ...
      if (this.affixed != r) {
        ...
        this.affixed = r, this.unpin = "bottom" == r ? this.getPinnedOffset() : null, this.$element.removeClass(_i4.RESET).addClass(l).trigger(l.replace("affix", "affixed") + ".bs.affix");
      }
  ...
  var o = t.fn.affix;
  t.fn.affix = e, t.fn.affix.Constructor = _i4, t.fn.affix.noConflict = function () {
...
function PowermailBackend() {
  ...
  var addPageBrowseParamsListener = function addPageBrowseParamsListener() {
    var paginationItems = document.querySelectorAll('.powermail_list .pagination a');
