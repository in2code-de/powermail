...
| Allowed ViewHelpers in parsed strings | Comma separated list of ViewHelpers that powermail may execute while it replaces variables in a mail subject, in the receiver name and email and in field titles. Every other ViewHelper is removed. See the note below. | f:cObject |
