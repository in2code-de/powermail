 ...
 *
 * @author	Alexander Kellner, Mischa Hei�mann <alexander.kellner@einpraegsam.net, typo3.2008@heissmann.org>
 * @package	TYPO3
...
//				}
	...
	function changeData($piVars, $contentElementData = array()) {
		...
		if (trim($this->uids) != '') {
			...
			$query = 'SELECT tx_powermail_fields.uid FROM tx_powermail_fields
