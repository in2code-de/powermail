 ...
 *
 *
 *   51: class tx_powermail_belist
 *  167:     function main($pid, $BACK_PATH = '', $mailID = 0, $noHeader = 0)
 *  337:     function pageBrowser($num = 1000, $numf = 10, $a = 0, $b = 10)
 *  383:     function inputFields()
 *  407:     function exportIcons()
 *  458:     function init($LANG)
 *
 * TOTAL FUNCTIONS: 5
...
/**
 * Plugin 'tx_powermail_belist' for the 'powermail' extension.
 *
